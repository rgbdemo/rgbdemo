...
namespace ntk
{
  void load_ply_vertices(std::vector<cv::Point3f>& vertices, const char* ply_file);
  void write_ply_vertices(const std::vector<cv::Point3f>& vertices, const char* ply_file);
