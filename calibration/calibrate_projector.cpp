...
public:
    ...
    Context() :
        ...
        opt_square_size("--pattern-size", "Square size in used defined scale", 0.04f),
        opt_offsetX_3x3("--offsetX_3x3", "Horizontal position of the 3x3 pattern", 0.66f),
        opt_offsetY_3x3("--offsetY_3x3", "Vertical position of the 3x3 pattern", 0.f),
        opt_offsetX_3x4("--offsetX_3x4", "Horizontal position of the 3x4 pattern", 0.f),
        opt_offsetY_3x4("--offsetY_3x4", "Vertical position of the 3x4 pattern", 0.f),
        opt_offsetX_3x5("--offsetX_3x5", "Horizontal position of the 3x5 pattern", 0.f),
        opt_offsetY_3x5("--offsetY_3x5", "Vertical position of the 3x5 pattern", 0.33f),
        opt_offsetX_3x6("--offsetX_3x6", "Horizontal position of the 3x6 pattern", 0.66f),
        opt_offsetY_3x6("--offsetY_3x6", "Vertical position of the 3x6 pattern", 0.29f),
	image_size(640,480),
